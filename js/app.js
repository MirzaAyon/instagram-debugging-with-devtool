...
const reportPost = (id) => {
  ...
  //reported posts are removing from home and visible from eye btn
...
const displayContent = (text) => {
  ...
  // return text.length < 30 ? 'text' : text.slice(0, 30) + "<span class='fw-bold'>... read more</span>";
  //this is the previes code where text parameter was showing in string as "text" so below 30 letters text's are showed as text
...
const displayLikedPosts = () => {
  document.getElementById("liked").innerHTML = ""; // removing previous div //error 6
...
const displayReportedPosts = () => {
  document.getElementById("reported").innerHTML = ""; // removing previous div //error 6
...
loadPosts();
//error - 4 --- 126 and 128 user and users comments are showing 